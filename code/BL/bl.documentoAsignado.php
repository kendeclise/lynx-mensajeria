	...
	if ($_POST)
		...
		//code
            ...
            {   $_idUsuario = isset($_SESSION['idUsuario'])?intval($_SESSION['idUsuario']):intval($_POST['idU']);
                ...
                if (sizeof($_datos)>0)
                {
                    echo utf8_encode($_datos[0]['resumen']);
                }
                else
                {
                    echo "<br><b>Lo sentimos .... No se encontro la especificaci&oacute;n del documento seleccionado</b>";
                }              
            }
        ...
        elseif ($_GET)
        {
            ...
            if($action=="cargarLista")
            {
                ...
                $_tipo      = isset($_GET['tipo'])?intval($_GET['tipo']):0;

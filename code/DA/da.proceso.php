...
class ClsProceso
{
    ...
    /**
     * Metodo que permite listar los campos de datos a procesar
     * @param type $_key1
     * @param type $_key2
     * @param type $_key3
     * @param type $_key4
    ...
    {
        $sqlProc = sprintf('CALL lynxbitacora.sp_his_historico(%d,%d,"%s","%s",%d,"%s")', $_tipo, $_usuario, $_instruccion, $_referencia, 

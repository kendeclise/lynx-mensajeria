...
<body>
                    ...
                    <form class="form-horizontal" role="form" id="frmDocumento" name="frmDocumento" action="principal.php" method="post">
                     <div class="form-group">
                        ...
                        <div class="col-lg-10" id="sCapaSelect">
                            ...
                            <select class="form-control" id="tDocumentoAsignado" name="tDocumentoAsignado" style="width:80%" required title="Seleccione" onchange="javascript:fcDocumentoAsignado()">
                            </select>
                            <div align="justify">
                     ...
                     <div class="form-group"  id="capa">
                        ...
                        <div class="col-lg-10" id="sCapaSelect">
                            ...
                            <div align="justify">
                                <span class="resumen" id="capaResumen">Seleccione la Orden, requerimiento o el Documento que tiene asignado dentro de la lista desplegable; 
    ...
    <script type="text/javascript">
        ...
        function fcDocumentoAsignado()
        {
            ...
            $("#capaResumen").html("Seleccione la Orden, requerimiento o el Documento que tiene asignado dentro de la lista desplegable;"+ 
                                "luego registre los datos que se les solicite de acuerdo a las opciones mostradas.");

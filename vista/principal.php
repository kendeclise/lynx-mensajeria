    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="capa">
            <div class="row">
                ...
                <div style="padding-left: 13px; padding-right: 13px" align="justify"><span class="resumen" >Seleccione una de las opciones de lista mostradas, para luego grabar datos correspondientes al proceso en referencia</span>
